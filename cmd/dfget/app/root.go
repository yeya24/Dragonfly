...
func initFlags() {
	...
	flagSet.VarP(&cfg.LocalLimit, "locallimit", "s",
		"network bandwidth rate limit for single download task, in format of G/g/M/m/K/k/B")
	flagSet.Var(&cfg.MinRate, "minrate",
		"minimal network bandwidth rate for downloading a file, in format of G/g/M/m/K/k/B")
	flagSet.Var(&cfg.TotalLimit, "totallimit",
		"network bandwidth rate limit for the whole host, in format of G/g/M/m/K/k/B")
